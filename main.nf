...
dataset="paired"
dir="/shared/liam/scratch/${dataset}-end"

params.multiqc_config="/shared/liam/scratch/pipeline/multiqc_config.yml"
params.dataset_name="${dataset}"
params.fastq_directory="${dir}/sample"
params.output_directory="${dir}/output"
params.reference_directory="/shared/reference-database/genomes/ensembl/release-102/homo_sapiens/GRCh38"
//params.reference_directory="/efs/reference-database/genomes/ensembl/release-102/homo_sapiens/GRCh38"
params.rRNA_interval_list="/shared/reference-database/genomes/rseqc/hg38_rRNA.interval_list"
...
workflow {
  ...
  salmon_index = Channel
    .fromPath("${params.reference_directory}/salmon-index", type: "dir", checkIfExists: true)
    .collect()

  reference_gtf = Channel
    .fromPath("${params.reference_directory}/gtf/reference.gtf.gz", checkIfExists: true)
    .collect()
  ...
  star_index = Channel
    .fromPath("${params.reference_directory}/star-index", type: "dir", checkIfExists: true)
    .collect()
  ...
  rsem_reference = Channel
    .fromPath("${params.reference_directory}/rsem-reference", type: "dir", checkIfExists: true)
    .collect()
  ...
  ref_flat = Channel
    .fromPath("${params.reference_directory}/gtf/reference.refFlat", checkIfExists: true)
    .collect()
...
//collect_salmon_transcript_quants(
  //  salmon_transcript_quants.map{ it -> it[1] }.collect())
  //collect_salmon_gene_quants(
  //  salmon_gene_quants.map{ it -> it[1] }.collect())
  //collect_rsem_transcript_quants(
  //  rsem_transcript_quants.map{ it -> it[1] }.collect())
  //collect_rsem_gene_quants(
  //  rsem_gene_quants.map{ it -> it[1] }.collect())
  collect_qc_metrics(
